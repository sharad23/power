...
class CreatePodBatteryWaterAddedTable extends Migration {
	...
	{
		//
	    Schema::create('pod_battery_water_added', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		//
		Schema::drop('pod_battery_water_added');
	}
